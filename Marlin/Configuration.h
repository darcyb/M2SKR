...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  18.9996
    #define DEFAULT_Ki   1.7463
    #define DEFAULT_Kd  51.6790
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 126.19
  #define DEFAULT_bedKi 3.76
  #define DEFAULT_bedKd 1059.57
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.88, 88.88, 1007.7, 471.5 } // new
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34.2, 0, -1.85 }
